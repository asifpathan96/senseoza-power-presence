...
import { ArrowRight, Sparkles, TrendingUp, Users, Zap, Brain, Search, Share2, FileText, MousePointerClick, Globe, Target, BarChart, Shield, CheckCircle, Lightbulb, Award, Building, Play, ArrowUpRight } from 'lucide-react';
        ...
        <div className="relative bg-gradient-to-br from-primary via-primary/90 to-accent rounded-2xl p-6 md:p-8 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-white/20 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform">
              <stat.icon className="h-6 md:h-7 w-6 md:w-7 text-white" />
            </div>
        ...
        <div className="container mx-auto px-4 z-10 py-32">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              Transform Your Digital Presence Into{' '}
              <span className="text-gradient-animated">Measurable Growth</span>
            </motion.h1>
            ...
            >
              <Link to="/contact">
                <Button size="lg" className="w-full sm:w-auto px-8 py-6 text-base bg-white text-primary hover:bg-white/90 shadow-xl shadow-white/20 hover:shadow-2xl hover:shadow-white/30 transition-all duration-300">
                  ...
                  >
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4">
                        <div className="w-12 h-12 bg-white/90 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg group-hover:bg-primary group-hover:text-white transition-colors duration-300">
