...
const Analytics = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
      <SEOHead
        title="Analytics & Reporting Services | Senseoza"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="p-4 bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl w-fit mb-6">
                <BarChart className="h-12 w-12 text-primary icon-3d" />
              </div>
              <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
                Analytics & Reporting
              </h1>
              <p className="text-xl text-muted-foreground mb-6">
                Track KPIs with dashboards and performance insights to make data-driven decisions and optimize continuously.
              </p>
      ...
      <section className="py-20 gradient-hero">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Let's set up analytics that give you clear insights into what's working.
          </p>
          <Link to="/contact">
