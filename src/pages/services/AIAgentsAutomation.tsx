          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection direction="right">
              ...
              <p className="text-xl text-white/80 mb-6">
                Imagine having a tireless digital workforce that handles repetitive tasks, makes intelligent decisions, and operates around the clock without breaks or errors. AI agents automate business processes—making decisions without human intervention while continuously learning and adapting.
              </p>
            ...
            <AnimatedSection direction="left" delay={0.2}>
              ...
              >
                ...
                <img 
                  src={serviceAiAgents} 
                  alt="AI Agents & Workflow Automation illustration" 
